class SeedOpenaiModelSettings < ActiveRecord::Migration[7.2]
  SETTINGS = {
    ...
    "openai_model_morning_message" => [ "gpt-5.4-nano", "Modelo para generar el mensaje matinal personalizado." ],
    "openai_model_free_response" => [ "gpt-5-mini", "Modelo para respuestas libres al participante por WhatsApp." ],
    "openai_model_inbound_intent_classifier" => [ "gpt-5.4-nano", "Modelo para clasificar semanticamente mensajes entrantes." ],
    ...
    "openai_model_skill_tagger" => [ "gpt-5.4-nano", "Modelo para etiquetar habilidades humanas detectadas en mensajes." ],
    "openai_model_manifesto" => [ "gpt-5-mini", "Modelo para generar el manifiesto de cierre." ],
    "openai_model_pattern_clusterer" => [ "gpt-5.4-nano", "Modelo para agrupar patrones recurrentes en metodologia." ],
